              ...
              <TableBody>
                {
                  <StyledTableRow >
                    <StyledTableCell align="left">
                      <Avatar
                        src={pathImgFromIndex + members.teacher.avatar}
                        alt="avatar"
                    ...
                    <StyledTableCell align="right">{members.teacher.gmail}</StyledTableCell>
                    <StyledTableCell align="right">{members.teacher.sex}</StyledTableCell>
                    <StyledTableCell align="right">{members.teacher.phone}</StyledTableCell>
                  </StyledTableRow>
                }
              </TableBody>
            </Table>
                  ...
                  <StyledTableRow key={row.username}>
                    ...
                    <StyledTableCell align="right">
                      <div
                        ...
                        onClick={handleDeleteMember(row.username)}
                      >
                        Xoá
                      </div>
                    </StyledTableCell>
