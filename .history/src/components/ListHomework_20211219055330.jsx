...
export default function ListHomework() {
  ...
  const loadingHomework = useSelector((state) => state.homeworkReducer?.loading);
  const errHomework = useSelector((state) => state.homeworkReducer?.err);

  const dataDocument = useSelector((state) => state.homeworkReducer?.data);
  const loadingDocument = useSelector((state) => state.homeworkReducer?.loading);
  const errDocument = useSelector((state) => state.homeworkReducer?.err);
  console.log(data);
  if (loading) {
    return <Loading />;
  }
