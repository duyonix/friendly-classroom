...
export const actSubmitHomeworkRequest = () => {
    return {
        type: actionTypes.SUBMITHOMEWORK_REQUEST,
    }
}

export const actSubmitHomeworkReset = () => {
    return {
        type: actionTypes.SUBMITHOMEWORK_RESET,
    }
}

export const actSubmitHomeworkSuccess = (data) => {
    return {
        type: actionTypes.SUBMITHOMEWORK_SUCCESS,
        payload: data
    }
}
export const actSubmitHomeworkFailed = (err) => {
    return {
        type: actionTypes.SUBMITHOMEWORK_FAILED,
        payload: err
    }
}