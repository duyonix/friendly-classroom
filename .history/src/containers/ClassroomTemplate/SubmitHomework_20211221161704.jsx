...
function format2Digits(n) {
  ...
  const convertDate = (date) => {
    date = new Date(date);
    let hours,minutes,secondsl
    hours = format2Digits(d.getHours());
    minutes = format2Digits(d.getMinutes());
    seconds = format2Digits(d.getSeconds());
     

    var dd = String(date.getDate()).padStart(2, "0");
    var mm = String(date.getMonth() + 1).padStart(2, "0");
    var yyyy = date.getFullYear();
    return hours + ":" + minutes + ":" + seconds + dd + "/" + mm + "/" + yyyy;
  };
  return (
          ...
          <div className="files">
            ...
            >
              <div class="card-body file-info">
                ...
                <p class="card-text file-type">Loại: {file.type}</p>
                <p class="card-text file-lastModified">
