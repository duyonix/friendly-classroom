  ...
  return (
    <div className="submit-homework container">
      ...
      <div className="description">
        <h2>Mô tả</h2>
        <p>
          Lorem ipsum dolor sit amet, consectetur adipisicing elit. Tempora earum maxime, error provident vel numquam voluptatibus incidunt illum iste fugit.
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure, possimus. Non dolores inventore esse praesentium suscipit error, maxime sit at architecto cumque porro quidem minima ullam sunt excepturi rem laudantium?
        </p>
      </div>
    </div>
  );
