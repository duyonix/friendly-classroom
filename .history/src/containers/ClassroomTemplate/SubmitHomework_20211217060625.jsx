  ...
  return (
    <div className="submit-homework container">
      ...
      <div className="description">
        <h1>Mô tả</h1>
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eligendi deserunt deleniti eius aliquid nemo, quaerat sequi error. Vitae, sapiente recusandae.</p>
      </div>
    </div>
  );
}
